            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Listagem de Alunos</h2>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mt-5 mb-3 clearfix">
                        ...
                        <a href="createAlunos.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Adicionar Aluno</a>
                    </div>
                    <?php
                                    ...
                                    while($row = mysqli_fetch_array($result)){
                                        echo "<tr>";
                                            ...
                                            echo "<td>";
                                                ...
                                                echo '<a href="deleteAlunos.php?id='. $row['id'] .'" title="Deletar Registro" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                            echo "</td>";
                                        echo "</tr>";
                                    }
                                    echo "</tbody>";
