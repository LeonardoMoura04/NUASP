...
class Parcelas{
    ...
    function read(){
        ...
        // Query
        $query = "SELECT p.*, 
                    d.numeroParcelas AS dividaParcelas, d.valorTotal AS dividaValor, d.isPaga AS dividaIsPaga, 
                    d.alunoId AS alunoId, d.instituicaoId AS instituicaoId, d.tipoPagamentoId AS tipoPagamentoId,
