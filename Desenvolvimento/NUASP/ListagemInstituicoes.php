                                ...
                                echo '<table class="table table-bordered table-striped">';
                                    ...
                                    while($row = mysqli_fetch_array($result)){
                                        echo "<tr>";
                                            ...
                                            echo "<td>" . $row['cnpj'] . "</td>";
                                            echo "<td>";
                                                echo '<a href="readInstituicoes.php?id='. $row['id'] .'" class="mr-3" title="Consultar Registro" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                                                echo '<a href="updateInstituicoes.php?id='. $row['id'] .'" class="mr-3" title="Atualizar Registro" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                                echo '<a href="deleteInstituicoes.php?id='. $row['id'] .'" title="Deletar Registro" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                            echo "</td>";
                                        echo "</tr>";
                                    }
                                    echo "</tbody>";
