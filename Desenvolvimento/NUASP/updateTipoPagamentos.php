    ...
    if(isset($_POST["id"]) && !empty($_POST["id"])){
        ...
        if(empty($nome_err)){
            ...
            if($stmt = mysqli_prepare($link, $sql)){
                ...
                mysqli_stmt_bind_param($stmt, "si", $param_nome, $param_id);
...
<body>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcrumb-content text-center">
                        <h2 class="page-title">Atualizar Tipos de Pagamento</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Atualizar Tipos de Pagamento</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mt-5">Atualizar Tipo de Pagamento</h2>
                    ...
                    <div class="form-group">
                        ...
                        <a href="listagemTipoPagamentos.php" class="btn btn-secondary ml-2">Cancelar</a>
                    </form>
                </div>
            </div>        
        </div>
